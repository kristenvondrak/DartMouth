...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        m_VenueTabs.invalidate();
        m_VenueTabs.requestLayout();
    ...
    public void changeInVenue() {
        ...
        m_MealTimesTabs.invalidate();
        m_MealTimesTabs.requestLayout();
    ...
    public void update() {
       ...
       // m_FoodItemsList = ParseAPI.recipesFromCloudForDate(day, month, year, venue, mealtime, menu);
