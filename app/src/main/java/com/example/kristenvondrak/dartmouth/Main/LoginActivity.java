    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_LoginTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (m_EmailEditText.getText() != null && isValidEmail(m_EmailEditText.getText().toString())) {
                    if (m_PasswordEditText.getText() != null && isValidPassword(m_PasswordEditText.getText().toString())) {
                        logInParseUser(m_EmailEditText.getText().toString(), m_PasswordEditText.getText().toString());
                        //createNewParseUser(m_EmailEditText.getText().toString(), m_PasswordEditText.getText().toString());
